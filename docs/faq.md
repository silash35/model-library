...
If you use the models or code in **academic work, articles, or reports**, you **must cite the original source of the model** whenever possible, as the original author's copyright is maintained.
However, most models in this repository are widely used and considered **common knowledge**, and therefore citation may not be necessary in general use.

Optionally, if your publisher allows citing GitHub repositories, you can cite this repository using the [CITATION.cff](/CITATION.cff) file included in the repository.
This file contains all the metadata necessary to generate a proper citation. You can also copy the citation automatically generated by GitHub from the repository interface.
We would greatly appreciate it if you cite the repository.
...
Yes! All images illustrating the modeled systems are released under the [Unlicense](https://unlicense.org/), allowing you to **freely use, modify, and distribute them** without restriction.

You may incorporate these images in **books, presentations, lectures, papers, or other projects** without the need for formal attribution.
Attribution is entirely optional, but it is appreciated whenever possible.

It’s important to note that these images are provided as **vector graphics in SVG format**, which can be easily edited in any vector graphics editor, such as Inkscape. They are intended for you to adapt and use in your projects as needed.
